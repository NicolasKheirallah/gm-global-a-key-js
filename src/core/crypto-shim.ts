import { aesEncryptBlock as aesEncryptBlockJs } from "./aes";
...
export const CryptoShim = {
  ...
  async aesEncryptBlock(
    ...
    if (typeof crypto === "undefined" || !crypto.subtle) {
      return aesEncryptBlockJs(key, block);
    }
    ...
    try {
      ...
      // The first 16 bytes of CBC with IV=0 are equivalent to single-block ECB.
